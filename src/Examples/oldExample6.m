...
%Keep the nonlinear Push-components; Swap the nonlinear pull-components to
%linear ones
semi_linear_signal = readArray(nonlinearSwap(linear_pull,nonlinear_push,2));
%Figure 
figure(1); hold on;
