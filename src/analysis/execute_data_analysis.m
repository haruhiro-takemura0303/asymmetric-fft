...
for trialNum = 1:trialLen
    ...
    % Horz
    save(SAVE_PATH+"/"+AMP_NAME+"/"+num2str(trialNum)+"/Horizontal"+"/clean.mat","cleanH",'-v7.3');
    save(SAVE_PATH+"/"+AMP_NAME+"/"+num2str(trialNum)+"/Horizontal"+"/commercial.mat","commercialH",'-v7.3');
    save(SAVE_PATH+"/"+AMP_NAME+"/"+num2str(trialNum)+"/Horizontal"+"/uni.mat","uniH",'-v7.3');
